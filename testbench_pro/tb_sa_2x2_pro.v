...
`timescale 1ns/1ps
// TB: 2x2 Systolic Array Module (Output Stationary)
module tb_sa_2x2;
    ...
    sa_2x2 dut (.clk(clk),.rst_n(rst_n),.start(start),
    ...
    initial begin
        ...
        $display("(Output Stationary Dataflow)");
        ...
        #(CLK_PERIOD*5);
        $display("=== SA 2x2 Test Complete ===");
        $finish;
    end
    
    // Timeout
    initial begin #(CLK_PERIOD*10000); $display("TIMEOUT!"); $finish; end
endmodule
